...
public:
    ...
    virtual bool initChild(std::string libpath, const nlohmann::json &rules) {
        return true;
    }
    ...
    virtual bool initParent(std::string libpath, const nlohmann::json &rules, pid_t tracee_pid) {
        return true;
    }
};
