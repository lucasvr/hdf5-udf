...
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_C_COMPILER=clang \
      -DCMAKE_C_FLAGS="-O3 -g -ggdb" -DCMAKE_CXX_FLAGS="-O3 -g -ggdb" ..
make %{?_smp_mflags}
...
- Changes to build on Fedora 32: disable tests, compile with clang
